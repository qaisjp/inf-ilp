...
data class Friend(val id: String, val name: String, val email: String) {
    companion object {
...
class FriendsViewAdapter(private val friends: List<Friend>) : RecyclerView.Adapter<FriendsViewAdapter.AccountViewHolder>() {
