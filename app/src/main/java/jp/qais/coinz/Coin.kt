...
data class Coin(val id: String, val currency: Currency, val latLng: LatLng, val value: Float, val shared: Boolean) : Parcelable {
    // Required for Firestore creation of Coins
    constructor() : this("null", Currency.GOLD, LatLng(), -0f, false)
